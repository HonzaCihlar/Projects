...
BEGIN
	DECLARE @start_time DATETIME, @end_time DATETIME, @bash_start_time DATETIME, @bash_end_time DATETIME;
	BEGIN TRY
		SET @bash_start_time = GETDATE();
		PRINT '============================'
		...
		SET @end_time = GETDATE()
		PRINT 'Loading Duration: ' + CAST(DATEDIFF(second, @start_time, @end_time) AS NVARCHAR) + ' seconds'
		SET @bash_end_time = GETDATE()
		PRINT '============================'
		PRINT 'Silver loading complete'
		PRINT '============================'
		PRINT 'Full Load Duration: ' + CAST(DATEDIFF(second, @bash_start_time, @bash_end_time) AS NVARCHAR) + ' seconds'
	END TRY
	BEGIN CATCH
